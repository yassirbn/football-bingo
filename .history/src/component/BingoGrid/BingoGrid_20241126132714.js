    ...
    <div className="p-4 relative">
      ...
      {bingo && (
        <div className="absolute inset-0 z-20 flex justify-center items-center">
          {/* Fireworks particles */}
          <div className="w-10 h-10 bg-yellow-400 rounded-full animate-fireworks opacity-75 absolute"></div>
          <div className="w-8 h-8 bg-blue-500 rounded-full animate-fireworks opacity-75 absolute"></div>
          <div className="w-12 h-12 bg-red-500 rounded-full animate-fireworks opacity-75 absolute"></div>
          <div className="w-10 h-10 bg-green-300 rounded-full animate-fireworks opacity-75 absolute"></div>
          <div className="w-9 h-9 bg-purple-600 rounded-full animate-fireworks opacity-75 absolute"></div>
        </div>
      )}
