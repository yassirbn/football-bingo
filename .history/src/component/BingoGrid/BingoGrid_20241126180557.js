    ...
    <div className="p-4 relative h-screen overflow-hidden">
      ...
      >
        {gridWords.map((word, index) => (
          <div
            key={index}
            className={`flex items-center justify-center border-0 text-center font-medium aspect-square p-2
              ${
                selectedCells[index]
            ...
            style={{
              // Simulate hand-drawn lines by adding subtle irregularity to grid lines
