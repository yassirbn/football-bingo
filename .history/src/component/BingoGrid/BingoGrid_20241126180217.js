    ...
    <div className="p-4 relative h-screen overflow-hidden">
      ...
      >
        {gridWords.map((word, index) => (
          <div
            key={index}
            className={`flex items-center justify-center border-dashed border-2 rounded-md text-center font-medium aspect-square p-2
              ${
                selectedCells[index]
            ...
            style={{
              borderRight:
                index % gridSize === gridSize - 1 ? "none" : "2px dashed black",
              borderBottom:
                Math.floor(index / gridSize) === gridSize - 1
                  ? "none"
                  : "2px dashed black",
              borderTop: "2px dashed black", // Adding top border for the first row
              borderLeft: "2px dashed black", // Adding left border for the first column
            }}
          >
            <span
