    ...
    <div className="p-4 relative h-screen">
      ...
      {bingo && (
        <div className="absolute inset-0 z-20 flex justify-center items-center pointer-events-none">
          {/* Firework Particles */}
          <div className="fireworks-particle w-10 h-10 bg-yellow-400 rounded-full animate-fireworks absolute" style={{ "--x": "50vw", "--y": "50vh" }}></div>
          <div className="fireworks-particle w-12 h-12 bg-red-500 rounded-full animate-fireworks absolute" style={{ "--x": "-30vw", "--y": "-30vh" }}></div>
          <div className="fireworks-particle w-8 h-8 bg-blue-400 rounded-full animate-fireworks absolute" style={{ "--x": "40vw", "--y": "-40vh" }}></div>
          <div className="fireworks-particle w-10 h-10 bg-green-300 rounded-full animate-fireworks absolute" style={{ "--x": "-40vw", "--y": "40vh" }}></div>
          <div className="fireworks-particle w-9 h-9 bg-purple-600 rounded-full animate-fireworks absolute" style={{ "--x": "30vw", "--y": "30vh" }}></div>
        </div>
      )}
