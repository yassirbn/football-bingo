    ...
    <div className="p-4">
      ...
      >
        {shuffledWords.map((word, index) => (
          <div
            key={index}
            className="flex items-center justify-center border-2 border-gray-300 rounded-md bg-gray-100 hover:bg-blue-200 cursor-pointer text-center font-medium aspect-square"
          >
            {word}
          </div>
        ))}
