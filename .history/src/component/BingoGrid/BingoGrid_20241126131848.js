    ...
    <div className="p-4 relative">
      ...
      {bingo && (
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <h2 className="text-5xl font-bold text-red-500 animate-bingo-fade">BINGO!</h2>
        </div>
      )}

      {/* Fireworks Animation */}
      {bingo && (
        <div className="absolute inset-0 z-20 flex justify-center items-center animate-fireworks">
          {/* Simple fireworks effect: circles expanding */}
          <div className="w-10 h-10 bg-yellow-500 rounded-full animate-fireworks opacity-75"></div>
