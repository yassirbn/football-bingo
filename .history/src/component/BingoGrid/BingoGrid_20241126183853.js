...
const BingoGrid = ({ words }) => {
  ...
  return (
    <div className="p-4 relative h-screen overflow-hidden">
      ...
      <div
        className="grid gap-0.5 border border-gray-700"
        style={{
      ...
      >
        {gridWords.map((word, index) => (
          <div
            key={index}
            className={`flex items-center justify-center border-b border-r border-gray-700 text-center font-medium aspect-square p-1
              ${selectedCells[index] ? "bg-blue-300" : "bg-gray-100 hover:bg-blue-200 cursor-pointer"}
          ...
          >
            <div
              ...
              } rounded-full flex items-center justify-center py-3 px-6 sm:py-4 sm:px-8 md:py-6 md:px-12 lg:py-8 lg:px-16`}
              style={{
            ...
            >
              <span
                className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-black font-handwriting"
              >
                {word}
              </span>
            </div>
