        ...
        {gridWords.map((word, index) => (
          <div
            ...
            className={`flex items-center justify-center border-2 rounded-md text-center font-medium aspect-square p-2
              ${selectedCells[index] ? "bg-transparent" : "bg-gray-100 hover:bg-blue-200 cursor-pointer"}
          ...
          >
            <div
              className={`${
                selectedCells[index]
                  ? "bg-blue-300 text-white" // Selected cells get a blue background
                  : "bg-transparent"
              } rounded-full flex items-center justify-center
              ${word === "FREE SPACE" ? "font-bold italic" : ""}
              py-3 px-6 sm:py-4 sm:px-8 md:py-6 md:px-12 lg:py-8 lg:px-16`}
              style={{
                width: "75px", // Adjusted for mobile/tablet responsiveness
                height: "75px", // Adjusted for mobile/tablet responsiveness
                minWidth: "75px", // Ensures the circle doesn't shrink smaller than this
              }}
            >
              <span
